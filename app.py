...
if page == 'Home':
    ...
    if st.button("Predict"):
        ...
        if predicted_species == 0:  # Setosa
           img = Image.open("C:\\Users\\KARISHMA\\Desktop\\imarticus\\Deployment\\DEMO2\\iris-setosa.jpg")

        elif predicted_species == 1:  # Versicolor
            img = Image.open("C:\\Users\\KARISHMA\\Desktop\\imarticus\\Deployment\\DEMO2\\iris-versicolor.jpg")

        elif predicted_species == 2:  # Virginica
            img = Image.open("C:\\Users\\KARISHMA\\Desktop\\imarticus\\Deployment\\DEMO2\\iris-virginica.jpg")
